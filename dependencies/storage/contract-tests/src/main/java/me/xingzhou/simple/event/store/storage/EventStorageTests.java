...
public abstract class EventStorageTests {
    ...
    class EmptyStorageTests {
        ...
        void createDuplicateStream() {
            ...
            Assertions.assertThatThrownBy(
                            () -> storage.appendEvent(streamName, Versions.UNDEFINED_STREAM, "anything", "{}"))
    ...
    class OneStreamStorageTests {
        ...
        void appendEventWithStaleVersion() {
            Assertions.assertThatThrownBy(() -> storage.appendEvent(streamName, Versions.NEW_STREAM, "anything", "{}"))
